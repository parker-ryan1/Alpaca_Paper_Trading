"""
Quick Start: Live Paper Trading with Random Forest ML

This script starts live paper trading with Random Forest strategy.
NO USER INPUT REQUIRED - Starts automatically!
"""
...
def main():
    ...
    try:
        ...
        if not hours['is_open']:
            ...
            print(f"\nThe system will wait until market opens and start trading automatically.")
        else:
        ...
        print(f"\n{'='*60}")
        print("[INFO] Trading will start automatically...")
        print("[INFO] Press Ctrl+C to stop trading at any time")
        print(f"{'='*60}\n")
        
        # Start trading (NO INPUT REQUIRED)
        ...
        print("3. Installed dependencies: pip install scikit-learn")
        sys.exit(1)
